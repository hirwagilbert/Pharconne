...
class Medicine(models.Model):
    ...
    supplier = models.ForeignKey(Supplier, on_delete=models.CASCADE, related_name='addmedicine', null=True)
    name = models.CharField(max_length=100)
...
class Pmedstock(models.Model):
    ...
    pharmacy = models.ForeignKey(Pharmacy, on_delete=models.CASCADE, related_name='addmedicine', null=True, blank=True)
