...
class SupplierAdmin(admin.ModelAdmin):
    list_display = ('S_id', 'name', 'contact')
...
class MedicineAdmin(admin.ModelAdmin):
    list_display = ('M_id', 'name', 'serial_number', 'exp_date', 'MFG_date', 'quantity', 'price')  # Customize which fields are displayed
...
class Pmedstock(admin.ModelAdmin):
    list_display = ('name', 'generic_name', 'sku', 'price', 'stock', 'status')
